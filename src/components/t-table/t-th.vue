<template>
	<view class="t-th" :style="{ 'width':width , 'border-width': thBorder + 'px' ,'border-color':borderColor,'font-size':fontSize+'px' ,'color':color,'justify-content':thAlignCpd}">
		<slot></slot>
	</view>
</template>
...
<style>
	.t-th {
		...
		padding: 15upx;
		width: 180upx;
		background-color: rgba(235, 61, 61, 0.03);
	}
</style>
